...
// ==============================================================
#ifndef __ultra_net_mac_mulcyx__HH__
#define __ultra_net_mac_mulcyx__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mac_mulcyx) {
    ...
    SC_CTOR(ultra_net_mac_mulcyx):  simcore_mac_3_U ("simcore_mac_3_U") {
