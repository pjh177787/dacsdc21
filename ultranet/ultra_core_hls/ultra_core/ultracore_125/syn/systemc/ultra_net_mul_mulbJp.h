...
// ==============================================================
#ifndef __ultra_net_mul_mulbJp__HH__
#define __ultra_net_mul_mulbJp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_mulbJp) {
    ...
    SC_CTOR(ultra_net_mul_mulbJp):  ACMP_smul_us_U ("ACMP_smul_us_U") {
