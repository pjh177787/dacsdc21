...
// ==============================================================
#ifndef __ultra_net_mul_32sdXL__HH__
#define __ultra_net_mul_32sdXL__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_32sdXL) {
    ...
    SC_CTOR(ultra_net_mul_32sdXL):  ACMP_mul_su_U ("ACMP_mul_su_U") {
