...
// ==============================================================
#ifndef __ultra_net_mul_14ndVL__HH__
#define __ultra_net_mul_14ndVL__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_14ndVL) {
    ...
    SC_CTOR(ultra_net_mul_14ndVL):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
