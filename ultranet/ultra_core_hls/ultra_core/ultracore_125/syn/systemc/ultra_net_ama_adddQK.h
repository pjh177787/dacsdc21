...
// ==============================================================
#ifndef __ultra_net_ama_adddQK__HH__
#define __ultra_net_ama_adddQK__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_ama_adddQK) {
    ...
    SC_CTOR(ultra_net_ama_adddQK):  simcore_ama_0_U ("simcore_ama_0_U") {
