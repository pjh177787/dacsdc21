...
// ==============================================================
#ifndef __ultra_net_mul_mulbIp__HH__
#define __ultra_net_mul_mulbIp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_mulbIp) {
    ...
    SC_CTOR(ultra_net_mul_mulbIp):  ACMP_smul_us_U ("ACMP_smul_us_U") {
