...
// ==============================================================
#ifndef __ultra_net_mul_multde__HH__
#define __ultra_net_mul_multde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_multde) {
    ...
    SC_CTOR(ultra_net_mul_multde):  ACMP_smul_su_U ("ACMP_smul_su_U") {
