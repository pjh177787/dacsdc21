...
// ==============================================================
#ifndef __ultra_net_mul_mulc8D__HH__
#define __ultra_net_mul_mulc8D__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_mulc8D) {
    ...
    SC_CTOR(ultra_net_mul_mulc8D):  ACMP_smul_us_U ("ACMP_smul_us_U") {
