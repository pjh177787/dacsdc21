...
// ==============================================================
#ifndef __ultra_net_mul_12nbHp__HH__
#define __ultra_net_mul_12nbHp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_12nbHp) {
    ...
    SC_CTOR(ultra_net_mul_12nbHp):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
