...
// ==============================================================
#ifndef __ultra_net_mac_mulbgk__HH__
#define __ultra_net_mac_mulbgk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mac_mulbgk) {
    ...
    SC_CTOR(ultra_net_mac_mulbgk):  simcore_mac_0_U ("simcore_mac_0_U") {
