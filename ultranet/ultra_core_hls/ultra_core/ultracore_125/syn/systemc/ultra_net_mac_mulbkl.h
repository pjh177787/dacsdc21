...
// ==============================================================
#ifndef __ultra_net_mac_mulbkl__HH__
#define __ultra_net_mac_mulbkl__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mac_mulbkl) {
    ...
    SC_CTOR(ultra_net_mac_mulbkl):  simcore_mac_1_U ("simcore_mac_1_U") {
