...
// ==============================================================
#ifndef __ultra_net_mac_mulbNq__HH__
#define __ultra_net_mac_mulbNq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mac_mulbNq) {
    ...
    SC_CTOR(ultra_net_mac_mulbNq):  simcore_mac_2_U ("simcore_mac_2_U") {
