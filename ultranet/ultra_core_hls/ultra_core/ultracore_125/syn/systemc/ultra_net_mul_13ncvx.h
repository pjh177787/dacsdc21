...
// ==============================================================
#ifndef __ultra_net_mul_13ncvx__HH__
#define __ultra_net_mul_13ncvx__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_13ncvx) {
    ...
    SC_CTOR(ultra_net_mul_13ncvx):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
