...
// ==============================================================
#ifndef __ultra_net_mul_20skbM__HH__
#define __ultra_net_mul_20skbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ultra_net_mul_20skbM) {
    ...
    SC_CTOR(ultra_net_mul_20skbM):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
