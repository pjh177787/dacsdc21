set moduleName stream_out_data_4
set isTopModule 0
...
set C_modelName {stream_out_data.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_V_V int 32 regular {fifo 1 volatile }  }
	{ row_buffer_0_V int 16 regular {array 704 { 1 3 } 1 1 }  }
	{ row_buffer_1_V int 16 regular {array 704 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "row_buffer_0_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "row_buffer_1_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ row_buffer_0_V_q0 sc_in sc_lv 16 signal 1 } 
	{ row_buffer_1_V_address0 sc_out sc_lv 10 signal 2 } 
	{ row_buffer_1_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ row_buffer_1_V_q0 sc_in sc_lv 16 signal 2 } 
	{ skip_flag sc_in sc_logic 1 signal 3 } 
	{ outRowIdx_V sc_in sc_lv 10 signal 4 } 
	{ startRowBufferIdx_V sc_in sc_lv 2 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_0_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "row_buffer_0_V", "role": "q0" }} , 
 	...
 	{ "name": "row_buffer_1_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "row_buffer_1_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ultra_net_mac_mulcyx_U585", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "16900"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "16900"}
]}
...
set Spec2ImplPortList { 
	...
	row_buffer_0_V { ap_memory {  { row_buffer_0_V_address0 mem_address 1 10 }  { row_buffer_0_V_ce0 mem_ce 1 1 }  { row_buffer_0_V_q0 mem_dout 0 16 } } }
	row_buffer_1_V { ap_memory {  { row_buffer_1_V_address0 mem_address 1 10 }  { row_buffer_1_V_ce0 mem_ce 1 1 }  { row_buffer_1_V_q0 mem_dout 0 16 } } }
