...
set out_width 27
set exp (i0+i1)*i2+i3
set arg_lists {i0 {22 1 +} i1 {8 1 +} s {23 1 +} i2 {4 0 +} m {27 1 +} i3 {27 0 +} p {27 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { invec_0_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { invec_1_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { invec_2_V_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { invec_3_V_read { I 4 vector } } \
} "
}
