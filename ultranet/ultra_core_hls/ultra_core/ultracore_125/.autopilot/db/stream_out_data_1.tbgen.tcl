set moduleName stream_out_data_1
set isTopModule 0
...
set C_modelName {stream_out_data.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_V_V int 64 regular {fifo 1 volatile }  }
	{ row_buffer_0_V int 32 regular {array 656 { 1 3 } 1 1 }  }
	{ row_buffer_1_V int 32 regular {array 656 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_V_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "row_buffer_0_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "row_buffer_1_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_0_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "row_buffer_0_V", "role": "q0" }} , 
 	...
 	{ "name": "row_buffer_1_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "row_buffer_1_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ultra_net_mac_mulbNq_U340", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "3940"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "3940"}
]}
...
set Spec2ImplPortList { 
	...
	row_buffer_0_V { ap_memory {  { row_buffer_0_V_address0 mem_address 1 10 }  { row_buffer_0_V_ce0 mem_ce 1 1 }  { row_buffer_0_V_q0 mem_dout 0 32 } } }
	row_buffer_1_V { ap_memory {  { row_buffer_1_V_address0 mem_address 1 10 }  { row_buffer_1_V_ce0 mem_ce 1 1 }  { row_buffer_1_V_q0 mem_dout 0 32 } } }
