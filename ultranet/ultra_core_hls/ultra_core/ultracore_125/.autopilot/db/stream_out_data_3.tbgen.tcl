set moduleName stream_out_data_3
set isTopModule 0
...
set C_modelName {stream_out_data.3}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_V_V int 32 regular {fifo 1 volatile }  }
	{ row_buffer_V int 32 regular {array 704 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "row_buffer_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ row_buffer_V_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ultra_net_mac_mulcyx_U535", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	row_buffer_V { ap_memory {  { row_buffer_V_address0 mem_address 1 10 }  { row_buffer_V_ce0 mem_ce 1 1 }  { row_buffer_V_q0 mem_dout 0 32 } } }
