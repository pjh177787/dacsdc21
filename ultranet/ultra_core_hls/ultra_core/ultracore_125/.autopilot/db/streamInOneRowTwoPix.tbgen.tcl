set moduleName streamInOneRowTwoPix
set isTopModule 0
...
set C_modelName {streamInOneRowTwoPix}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V_V int 16 regular {fifo 0 volatile }  }
	{ row_buffer_0_V int 8 regular {array 640 { 3 0 } 0 1 }  }
	{ row_buffer_1_V int 8 regular {array 640 { 3 0 } 0 1 }  }
	{ skip_flag uint 1 regular  }
	{ rowBufferIdx_V int 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "row_buffer_0_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "row_buffer_1_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ row_buffer_0_V_d1 sc_out sc_lv 8 signal 1 } 
	...
	{ row_buffer_1_V_d1 sc_out sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_0_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "row_buffer_0_V", "role": "d1" }} , 
 	...
 	{ "name": "row_buffer_1_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "row_buffer_1_V", "role": "d1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "642"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "642"}
]}
...
set Spec2ImplPortList { 
	...
	row_buffer_0_V { ap_memory {  { row_buffer_0_V_address1 MemPortADDR2 1 10 }  { row_buffer_0_V_ce1 MemPortCE2 1 1 }  { row_buffer_0_V_we1 MemPortWE2 1 1 }  { row_buffer_0_V_d1 MemPortDIN2 1 8 } } }
	row_buffer_1_V { ap_memory {  { row_buffer_1_V_address1 MemPortADDR2 1 10 }  { row_buffer_1_V_ce1 MemPortCE2 1 1 }  { row_buffer_1_V_we1 MemPortWE2 1 1 }  { row_buffer_1_V_d1 MemPortDIN2 1 8 } } }
