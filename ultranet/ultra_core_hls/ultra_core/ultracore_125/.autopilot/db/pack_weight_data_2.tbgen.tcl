set moduleName pack_weight_data_2
set isTopModule 0
...
set C_modelName {pack_weight_data.2}
...
set C_modelArgMapList {[ 
	{ "Name" : "w2_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "w1_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "w0_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "ap_return", "interface" : "wire", "bitwidth" : 416} ]}
# RTL Port declarations: 
set portNum 20
set portList { 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ w2_V sc_in sc_lv 64 signal 0 } 
	{ w1_V sc_in sc_lv 64 signal 1 } 
	{ w0_V sc_in sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "w2_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "w2_V", "role": "default" }} , 
 	{ "name": "w1_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "w1_V", "role": "default" }} , 
 	{ "name": "w0_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "w0_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	w2_V { ap_none {  { w2_V in_data 0 64 } } }
	w1_V { ap_none {  { w1_V in_data 0 64 } } }
	w0_V { ap_none {  { w0_V in_data 0 64 } } }
}
