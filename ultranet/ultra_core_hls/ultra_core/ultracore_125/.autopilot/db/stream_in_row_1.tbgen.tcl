set moduleName stream_in_row_1
set isTopModule 0
...
set portList { 
	...
	{ row_buffer_V_address1 sc_out sc_lv 10 signal 1 } 
	{ row_buffer_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ row_buffer_V_we1 sc_out sc_logic 1 signal 1 } 
	{ row_buffer_V_d1 sc_out sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "address1" }} , 
 	...
 	{ "name": "row_buffer_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "d1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "171"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "171"}
]}
...
set Spec2ImplPortList { 
	...
	row_buffer_V { ap_memory {  { row_buffer_V_address1 MemPortADDR2 1 10 }  { row_buffer_V_ce1 MemPortCE2 1 1 }  { row_buffer_V_we1 MemPortWE2 1 1 }  { row_buffer_V_d1 MemPortDIN2 1 64 } } }
