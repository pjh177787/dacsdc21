set moduleName stream_out_data
set isTopModule 0
...
set C_modelName {stream_out_data}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_V_V int 128 regular {fifo 1 volatile }  }
	{ row_buffer_V int 128 regular {array 324 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_V_V", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "row_buffer_V", "interface" : "memory", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_buffer_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "address0" }} , 
 	{ "name": "row_buffer_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "ce0" }} , 
 	{ "name": "row_buffer_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "row_buffer_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ultra_net_mac_mulbkl_U222", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "1948"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "1948"}
]}
...
set Spec2ImplPortList { 
	...
	row_buffer_V { ap_memory {  { row_buffer_V_address0 mem_address 1 9 }  { row_buffer_V_ce0 mem_ce 1 1 }  { row_buffer_V_q0 mem_dout 0 128 } } }
